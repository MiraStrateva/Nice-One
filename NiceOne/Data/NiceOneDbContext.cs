    ...
    public class NiceOneDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Category>().HasData(
                ...
                new Category() { Id = 3, Name = "Learn", Description = "Consultant", ImageUrl = "https://www.pngkey.com/png/full/332-3321371_learning-clipart-discovery-animations-png-discovery-learning.png" },
                new Category() { Id = 4, Name = "Have a drink", Description = "Developer", ImageUrl = "https://i1.wp.com/blog.hellofresh.co.uk/wp-content/uploads/2015/12/Xmas_Cocktails_2015_DEFINITIV1.png?resize=800%2C500" },
                new Category() { Id = 5, Name = "Do your hair", Description = "Developer", ImageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS5Y4eCLP8GJvkqCiPflhJzbXwIqnPDZotbang-O3FaE0_l3tVL&usqp=CAU" },
                new Category() { Id = 6, Name = "Relax", Description = "Developer", ImageUrl = "https://pngriver.com/wp-content/uploads/2018/04/Download-Relax-Transparent-PNG.png" });
